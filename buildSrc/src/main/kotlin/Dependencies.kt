...
object AutoDipsose {
  ...
  const val autoDisposeAndroidArch = "com.uber.autodispose:autodispose-android-archcomponents:$version"
}
...
object ThreeTenBp {
  ...
  const val android = "com.jakewharton.threetenabp:threetenabp:1.2.0"
}